#' Generate meta-data for Adaptation Atlas Laers
#'
...
#' @param grid.proj This field is auto-filled if the dataset is provided as the `data` parameter. The proj4 or EPSG code of the dataset.
